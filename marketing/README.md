...
- `switchy-awesome-ai-memory-pr.md`: Switchy Awesome AI Memory PR packet and
  validation notes.
- `trionlabs-awesome-ai-memory-pr.md`: Trionlabs Awesome AI Memory PR packet
  and validation notes.
- `ishandutta-awesome-ai-memory-extensions-pr.md`: Ishandutta Awesome AI Memory
...
- `ishandutta-awesome-claude-skills-pr.md`: Ishandutta Awesome Claude Skills PR
  packet and validation notes.
- `kenryu-awesome-claude-skills-pr.md`: Kenryu Awesome Claude Skills PR packet
  and validation notes.
- `sandipan-awesome-claude-skills-pr.md`: Sandipan Awesome Claude Skills PR
  packet and validation notes.
...
- `bbylw-awesome-claude-skills-cn-pr.md`: Bbylw Awesome Claude Skills CN PR
  packet and validation notes.
- `ammosu-awesome-claude-skills-zh-tw-pr.md`: Ammosu Awesome Claude Skills
  ZH-TW PR packet and validation notes.
...
- Daniel Rosehill Awesome AI Coding Tools PR:
  `https://github.com/danielrosehill/Awesome-AI-Coding-Tools/pull/10`
...
- Trionlabs Awesome AI Memory PR:
  `https://github.com/trionlabs/awesome-ai-memory/pull/2`
- Ishandutta Awesome AI Memory Extensions PR:
...
- Wfnuser Awesome Agent Memory PR: `https://github.com/wfnuser/Awesome-Agent-Memory/pull/9`
...
- Kenryu Awesome Claude Skills PR:
  `https://github.com/kenryu42/awesome-claude-skills/pull/22`
- Sandipan Awesome Claude Skills PR:
...
- Ammosu Awesome Claude Skills ZH-TW PR:
  `https://github.com/ammosu/awesome-claude-skills-zh-TW/pull/7`
...
- VB Web AI Tools submission: sent to `info@vbwebtools.com` after the public
  form's WordPress AJAX endpoint returned `-1`.
...
- Ishandutta Awesome AI Memory Extensions PR:
  `https://github.com/ishandutta2007/Awesome-AI-Memory-Extensions/pull/3`
- Ishandutta Awesome AI Memory Extensions evidence update:
  `https://github.com/TerminallyLazy/Tree-Ring-Memory/issues/26#issuecomment-4910798542`
- Ishandutta Awesome AI Memory Assistants PR:
  `https://github.com/ishandutta2007/Awesome-AI-Memory-Assistants/pull/4`
